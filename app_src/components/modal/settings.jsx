        ...
        <div className="app-modal-body-inner">
          <form className="fields" onSubmit={save}>
            ...
            <div className="field hostBrdTopContrast">
              ...
              <div className="field-mini-label">Add</div>
              <div className="field-input">
                <input id="shortcutAdd" value={context.state.shortcut.add.join(" + ")} onKeyDown={changeShortCut} className="topcoat-textarea" />
              </div>
              <div className="field-mini-label">Center</div>
              <div className="field-input">
